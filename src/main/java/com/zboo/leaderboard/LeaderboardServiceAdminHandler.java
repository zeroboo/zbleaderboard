...
public class LeaderboardServiceAdminHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    public LeaderboardServiceAdminHandler(LeaderboardService owner) {
        super();
